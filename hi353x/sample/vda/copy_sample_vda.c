...
int main(int argc, char *argv[])
{
    ...
    PIC_SIZE_E enSize_Md = PIC_VGA, enSize_Od = PIC_VGA; 	/* vda picture size */
    ...
    ******************************************/
    ...
    fprintf(stdout, "init mpp succeed!\n");
    ...
    ******************************************/
    ...
    fprintf(stdout, "vo is standard model succeed!\n");
#else
    ...
    ******************************************/
    ...
    fprintf(stdout, "after SAMPLE_COMM_VO_StartDevLayer!\n"); 
