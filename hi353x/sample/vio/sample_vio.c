...
HI_S32 SAMPLE_VIO_16D1_Normal(HI_VOID)
{
    ...
    ******************************************/
    ...
    fprintf(stdout, "lgy-> step1 success!\n");
    /******************************************
...
*/
    ...
    u32BlkSize = SAMPLE_COMM_SYS_CalcPicVbBlkSize(gs_enNorm,\
                PIC_HD1080, SAMPLE_PIXEL_FORMAT, SAMPLE_SYS_ALIGN_WIDTH);//lgy PIC_D1->PIC_HD1080
...
HI_S32 SAMPLE_VIO_1D1_LossDet(HI_VOID)
{
    ...
    ******************************************/
#if HICHIP == HI3531_V100 
    fprintf(stdout, "this is HI3531_V100\n"); 
    VoDev = SAMPLE_VO_DEV_DSD0;
    u32WndNum = 1;
    enVoMode = VO_MODE_1MUX;
    ...
    stVoPubAttr.bDoubleFrame = HI_FALSE;
#else
    fprintf(stdout, "this is not HI3531_V100\n");
    VoDev = SAMPLE_VO_DEV_DHD0;
    u32WndNum = 1;
    enVoMode = VO_MODE_1MUX;
